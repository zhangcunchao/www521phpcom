...
<p>正在为您打开</p>
<p>=====<font color="#ff0000"><b>【<?php echo $this->_tpl_vars['title']; ?>
...
"><?php echo $this->_tpl_vars['url']; ?>
  ...
  <br>
P R 查询：<a href="http://tool.chinaz.com/Ranks/?PRAddress=<?php echo $this->_tpl_vars['url']; ?>
" target="_blank">点此查看<?php echo $this->_tpl_vars['title']; ?>
的PR</a>
&nbsp;&nbsp;Alexa查询：<a href="http://www.alexa.com/siteinfo/<?php echo $this->_tpl_vars['url']; ?>
" target="_blank">点此查看<?php echo $this->_tpl_vars['title']; ?>
的排名</a>
</p>
<!--如果你打不开网站请点击：<a href="http://lusongsong.com/daohang/error.asp?id=30378" target="_blank"><font color="#FF0000">报告错误</font></a><br><br>-->
</td></tr></tbody></table>
<br>
<br><br>
<br>
