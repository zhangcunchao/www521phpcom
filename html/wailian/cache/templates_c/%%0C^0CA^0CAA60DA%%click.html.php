<?php /* Smarty version 2.6.25, created on 2013-08-05 22:02:00
         compiled from www/click.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'www/click.html', 38, false),)), $this); ?>
...
<font style="color:#999; font-size:13px; text-decoration:none;">链入本站:<span style="color:#F00"><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['innum']; ?>
</span>次</font> <font style="color:#999; font-size:13px; text-decoration:none;">本站链出:<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['outnum']; ?>
次</font><br />
