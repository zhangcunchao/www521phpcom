...
//		$pinfo.='<a href="'.$this->url.'page=1">'.$this->first.'</a>&nbsp;&nbsp;';
		...
		if ($this->prevPage)
		$pinfo.='<li class="up"><a href="'.$this->url.'page='.$this->prevPage.'">'.$this->prev.'</a></li>&nbsp;&nbsp;';
		else
		$pinfo.='<li class="up">'.$this->prev.'</li>'.'&nbsp;&nbsp;';

		$pinfo.="<li>第{$this->page}页&nbsp;/共{$this->pageNum}页&nbsp;&nbsp;</li>";

		if ($this->nextPage)
		$pinfo.='<li class="down"><a href="'.$this->url.'page='.$this->nextPage.'">'.$this->next.'</a></li>&nbsp;&nbsp;';
		else
		$pinfo.='<li class="down">'.$this->next.'</li>'.'&nbsp;&nbsp;';
