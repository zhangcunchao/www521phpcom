...
<title>php将中文转化为拼音接口</title>
</head>

<body>
<p>http://www.521php.com/api/pinyin.php?str=张存超&type=1<p>
<p>这是将中文转化为拼音的接口，str是要转化的汉字，type是类型，有值就输出字符串，无值就输出json数组<p>
<p>例上面的例子就会输出string(12) "zhangcunchao"</p>
<p>type有值将输出</p>
<p>["zhang","cun","chao"]</p>
<p>如有疑问或意见，请联系我，我的博客<a href="http://www.521php.com" target="_blank">www.521php.com</a></p>
</body>
<?php
}
?>