...
$api = "本站接口:<br>http://www.521php.com/api/ip.php?ip=IP地址&format=返回格式(text,js,json)&charset=返回编码(utf8,gbk)";
...
echo $add;
	...
	echo '<title>php获取ip对应地址接口</title>';
	echo $api.'<br />';
	echo '如有任何问题请联系我的博客<a href="www.521php.com" target="_blank">www.521php.com</a>';
}
