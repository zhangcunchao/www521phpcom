	...
	$.fn.lightBox = function(settings) {
		...
		function _start(objClicked,jQueryMatchedObj) {
			...
			if ( jQueryMatchedObj.length == 1 ) {
				//settings.imageArray.push(new Array(objClicked.getAttribute('href'),objClicked.getAttribute('span')));
				settings.imageArray.push(new Array(objClicked.getAttribute('href'),$("#test").html()));
				//alert(" test" +objClicked.getAttribute('span'));
			} else {
				// Add an Array (as many as we have), with href and title atributes, inside the Array that storage the images references		
				for ( var i = 0; i < jQueryMatchedObj.length; i++ ) {
					//settings.imageArray.push(new Array(jQueryMatchedObj[i].getAttribute('href'),jQueryMatchedObj[i].getAttribute('title')));
					settings.imageArray.push(new Array(jQueryMatchedObj[i].getAttribute('href'),$("#test"+i).html()));
					//var spans = objClicked.getAttribute("id");
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			...
			// Diferences
			if(intWidth>800){
				intHeight = intHeight*(800/intWidth)+40;
				intWidth = 840;
			}
