...
<body class="login">
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="<?php echo esc_url( apply_filters('login_headerurl', 'http://www.521php.com/') ); ?>" title="<?php echo esc_attr( apply_filters('login_headertitle', __( 'Powered by WordPress' ) ) ); ?>"><?php bloginfo('name'); ?></a></h1>
<?php   } else { ?>
...
<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( site_url( 'wp-login.bak.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
	<p>
...
<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.bak.php', 'login_post' ) ); ?>" method="post">
	<p>
		<label for="user_login"><?php _e('Username') ?><br />
