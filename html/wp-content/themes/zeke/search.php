...
<!--中间内容-->
    <div id="container">
    	<div id="content">
        		<!--<div class="box"><?php printf( __('Keyword: &#8216;%1$s&#8217;', 'mruu'), wp_specialchars($s, 1) ); ?> <?php _e('Search Results', 'mruu'); ?></div>-->
	...
	<?php else: ?><?php if (has_post_thumbnail()) { the_post_thumbnail('home-thumb' ,array('class' => 'home-thumb')); }
                        ...
                        <div class="text2"><?php if(is_category() || is_archive() || is_home() || is_search() ) {
						the_excerpt();
						} else {
...
?>
            ...
            <?php endwhile;else : ?>
            <div class="errorbox">
            	<p><?php _e('Sorry, no posts matched your criteria.', 'mruu'); ?></p>
                <?php get_search_form(); ?>
			</div>
            <?php endif; ?>
