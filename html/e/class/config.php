...
$phome_db_username='v186_www';	//数据库用户名
$phome_db_password='zcc5574302';	//数据库密码
$phome_db_dbname='v186_www';	//数据库名
...
$do_ecookiernd='eTAKVHiNyhC8Asj55Ei2wNG96Y36rj';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
$do_ckhloginfile=0;	//后台是否启用文件验证,0为验证,1为不验证
$do_ckhloginip=0;	//后台是否验证登录IP,0为不验证,1为验证
$do_theloginlog=0;	//是否记录登陆日志(0为记录,1为不记录)
$do_thedolog=1;		//是否记录操作日志(0为记录,1为不记录)

//COOKIE设置
$phome_cookiedomain='';		//cookie作用域
$phome_cookiepath='/';		//cookie作用路径
$phome_cookievarpre='auucj';		//前台cookie变量前缀
$phome_cookieadminvarpre='raxja';		//后台cookie变量前缀
$phome_cookieckrnd='3rB6G2AFjF7HPCvuWzAa7taVqrqb3H';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'我爱你php张存超技术博客',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'ds69F8tyHmTdxBE3ETFR9s6Zdkvxeg',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/xiangce/\">相册集</a>&nbsp;|&nbsp;<a href=\"/2y/\">每天赚2元中奖名单</a>',
'plgroupid'=>0,
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
