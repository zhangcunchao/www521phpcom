...
function get_links($category = -1, $before = '', $after = '<br />', $between = ' ', $show_images = true, $orderby = 'name',
			$show_description = true, $show_rating = false, $limit = -1, $show_updated = 1, $echo = true,$jsr='') {
	_deprecated_function( __FUNCTION__, '2.1', 'get_bookmarks()' );
	...
	foreach ( (array) $results as $row ) {
		...
		if($jsr){
			$output .=' onmouseup="t=this; setTimeout(function() {t.href=\'' .$the_link. '\';}, 50); return true;" onmousedown="this.href=\''.$jsr.$the_link.'\'; return true;"';
		}
		$output .=  '>';
