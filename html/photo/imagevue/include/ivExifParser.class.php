...
class ivExifParser
{
	 ...
	 * @var array
	 * You can add or remove EXIF tags by commeting or de-commenting them with //
	 */
	 ...
	 * @return string
	 */
	function _simplifyFraction($fraction)
	{
	 ...
	 * @param array $exifData
	 */
	function Brand(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function Exposure(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function Aperture(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function FocalLength(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function ISOSpeed(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function ExposureBias(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function Flash(&$filtered, $exifData)
	{
		$flash = array(
		...
		if (isset($exifData['Flash']) && isset($flash[$exifData['Flash']])) {
	 ...
	 * @param array $exifData
	 */
	function ImageDescription(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function Orientation(&$filtered, $exifData)
	{
		$orientations = array(
			1 => 'Horizontal (normal)'
		);
	 ...
	 * @param array $exifData
	 */
	function XYResolution(&$filtered, $exifData)
	{
		$units = array(
			2 => 'dpi',
			3 => 'dpcm'
	 ...
	 * @param array $exifData
	 */
	function Software(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function DateAndTime(&$filtered, $exifData)
	{
	...
	function YCbCrPositioning(&$filtered, $exifData)
	{
		$positionings = array(
			1 => 'Centered',
			2 => 'Co-Sited'
	 ...
	 * @param array $exifData
	 */
	function ExposureProgram(&$filtered, $exifData)
	{
		$programs = array(
			1 => 'Manual',
			2 => 'Normal',
	...
	function DateAndTimeOriginal(&$filtered, $exifData)
	{
		if (isset($exifData['DateTimeOriginal'])) {
			$filtered['Date and Time (Original)'] = $exifData['DateTimeOriginal'];
		}
	}
	 ...
	 * @param array $exifData
	 */
	function DateAndTimeDigitized(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function CompressedBitsPerPixel(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function ShutterSpeed(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function Brightness(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function MaximumLensAperture(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function MeteringMode(&$filtered, $exifData)
	{
		$modes = array(
			1 => 'Average',
	 ...
	 * @param array $exifData
	 */
	function ColorSpace(&$filtered, $exifData)
	{
		$spaces = array(
			1 => 'sRGB'
		);
	 ...
	 * @param array $exifData
	 */
	function FocalPlaneXYResolution(&$filtered, $exifData)
	{
		$units = array(
			2 => 'dpi',
			3 => 'dpcm'
	 ...
	 * @param array $exifData
	 */
	function BitsPerSample(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function SensingMethod(&$filtered, $exifData)
	{
		$methods = array(
	 ...
	 * @param array $exifData
	 */
	function Compression(&$filtered, $exifData)
	{
		$compressions = array(
			1 => 'Uncompressed',
			6 => 'JPEG'
	 ...
	 * @param array $exifData
	 */
	function FirmwareVersion(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function PhotometricInterpretation(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function StripOffsets(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function SamplesPerPixel(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function RowsPerStrip(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function StripByteCounts(&$filtered, $exifData)
	{
	 ...
	 * @param array $exifData
	 */
	function Dimensions(&$filtered, $exifData)
	{
