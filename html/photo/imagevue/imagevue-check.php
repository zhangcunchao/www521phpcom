...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Imagevue Test Script</title>
		<style type="text/css">
	...
	<body>
		...
		<table>
			<?php if (checkModule('suhosin')): ?>
				<tr>
					...
					<td>suhosin</td>
					<td>Oh, bad luck. This is some 'hardened php' project which went wrong. You'll have to disable it.
						<a href="http://anonym.to/?http://imagevuex.com/forum/viewtopic.php?p=13808#13808">Related topic on imagevuex.com</a>
					</td>
				</tr>
			<?php endif; ?>
			<tr>
				<td><img src="<?php echo (version_compare('4.3.0', phpversion()) > 0 ? '?error.gif' : '?ok.gif'); ?>" alt="" /></td>
				<td>php&nbsp;version&nbsp;<?php echo phpversion(); ?></td>
				<td>
					Imagevue X2 requires a server that runs PHP ver.4.3.0+. PHP is a serverside scripting language standard on most servers these days, but if you are unsure if you have it, you still need to check.
		...
		<p>&copy; &nbsp; <a href="http://anonym.to/?http://www.imagevuex.com">imagevueX.com</a></p>
	</body>
</html>